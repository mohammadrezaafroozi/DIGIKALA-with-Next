  ...
  return (
    <main className="p-4 ">
      ...
      <div className="flex justify-between mb-3 md:p-4  items-center">
        ...
        <div>
          <Link className="text-blue-800 flex text-sm md:text-base justify-center items-center gap-x-3  p-1" href='components/home7'> 
          <FaArrowLeft/> مشاهده همه 
        </Link>
        </div>
      </div>

      <ProductSlider products={data.result.home_5.products} />
    </main>
  );
}