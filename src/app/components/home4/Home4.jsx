  ...
  return (
    <main className="p-4 bg-white">
      ...
      <div className="flex justify-between mb-3 md:p-4  items-center">
        ...
        {data.result.home_2.title}
        </h1></div>
        <div>
          <Link className="text-blue-800 flex text-sm md:text-base justify-center items-center gap-x-3 p-1" href='components/home4'> 
          <FaArrowLeft/> مشاهده همه 
        </Link>
        </div>
      </div>

      <ProductSlider products={data.result.home_2.products} />
    </main>
  );
}